...
#define HADRONS_NON_HERMITIAN_SCHUR_OP(conv) _HADRONS_SCHUR_OP_(conv)
#define HADRONS_DEFAULT_NON_HERMITIAN_SCHUR_OP HADRONS_SCHUR_OP(HADRONS_DEFAULT_SCHUR)
...
#define HADRONS_NON_HERMITIAN_SCHUR_SOLVE(conv) _HADRONS_SCHUR_SOLVE_(conv)
#define HADRONS_DEFAULT_NON_HERMITIAN_SCHUR_SOLVE HADRONS_SCHUR_SOLVE(HADRONS_DEFAULT_SCHUR)
