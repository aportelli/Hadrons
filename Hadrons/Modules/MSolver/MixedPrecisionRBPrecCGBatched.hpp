/*
 * MixedPrecisionRBPrecCGBatched.hpp, part of Hadrons (https://github.com/aportelli/Hadrons)
 *
...
/*  END LEGAL */
#ifndef Hadrons_MSolver_MixedPrecisionRBPrecCGBatched_hpp_
#define Hadrons_MSolver_MixedPrecisionRBPrecCGBatched_hpp_
...
class MixedPrecisionRBPrecCGBatchedPar: Serializable
{
public:
    GRID_SERIALIZABLE_CLASS_MEMBERS(MixedPrecisionRBPrecCGBatchedPar,
...
class TMixedPrecisionRBPrecCGBatched: public Module<MixedPrecisionRBPrecCGBatchedPar>
{
public:
...
public:
    // constructor
    TMixedPrecisionRBPrecCGBatched(const std::string name);
    // destructor
    virtual ~TMixedPrecisionRBPrecCGBatched(void) {};
    // dependency relation
...
MODULE_REGISTER_TMP(MixedPrecisionRBPrecCGBatched, ARG(TMixedPrecisionRBPrecCGBatched<FIMPLF, FIMPLD>), MSolver);
MODULE_REGISTER_TMP(ZMixedPrecisionRBPrecCGBatched, ARG(TMixedPrecisionRBPrecCGBatched<ZFIMPLF, ZFIMPLD>), MSolver);

/******************************************************************************
 *                 TMixedPrecisionRBPrecCGBatched implementation                     *
 ******************************************************************************/
// constructor /////////////////////////////////////////////////////////////////
template <typename FImplInner, typename FImplOuter>
TMixedPrecisionRBPrecCGBatched<FImplInner, FImplOuter>::TMixedPrecisionRBPrecCGBatched(const std::string name)
: Module<MixedPrecisionRBPrecCGBatchedPar>(name)
{}

// dependencies/products ///////////////////////////////////////////////////////
template <typename FImplInner, typename FImplOuter>
std::vector<std::string> TMixedPrecisionRBPrecCGBatched<FImplInner, FImplOuter>::getInput(void)
{
...
template <typename FImplInner, typename FImplOuter>
std::vector<std::string> TMixedPrecisionRBPrecCGBatched<FImplInner, FImplOuter>::getOutput(void)
{
...
template <typename FImplInner, typename FImplOuter>
DependencyMap TMixedPrecisionRBPrecCGBatched<FImplInner, FImplOuter>::getObjectDependencies(void)
{
    DependencyMap dep;
...
template <typename FImplInner, typename FImplOuter>
void TMixedPrecisionRBPrecCGBatched<FImplInner, FImplOuter>::setup(void)
{
...
// execution ///////////////////////////////////////////////////////////////////
template <typename FImplInner, typename FImplOuter>
void TMixedPrecisionRBPrecCGBatched<FImplInner, FImplOuter>::execute(void)
{}
...
#endif // Hadrons_MSolver_MixedPrecisionRBPrecCGBatched_hpp_
